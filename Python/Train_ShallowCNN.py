...
path_to_logs_dir = './log/ShallowCNN_MaskedImage_Blur'
path_to_logs_dir = os.path.join('.','log','ShallowCNN_'+args.dataset+'_Blur')
...
if __name__ == '__main__':
    ...
    dataset = MRIDataset(path_to_data, path_to_label, mode=MODE, transform=Transform, blur=True)
    ...
    dataset_test = MRIDataset(path_to_testdata, path_to_testlabel, mode=MODE, transform=Transform, blur=True)
