...
parser.add_argument("-s", "--size", type=int, choices=[299,384], default=299, help='Specify input image size')
...
path_to_logs_dir = os.path.join('.','log_Inception','InceptionV3_ImageSize_'+str(args.size)+'_'+args.dataset+'_area10000_aug2(1e-5)_weightdecay(1)')
