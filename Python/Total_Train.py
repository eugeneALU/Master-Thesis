...
parser.add_argument("-n", "--network", choices=['Resnet_onechannel', 'Resnet_pretrain',
                    'Resnet_depthwise', 'Xception', 'Inception_v3'], default='Resnet_onechannel', help='Specify the model')
