function [RealQrapImage TIvec TEvec] = phaseQMimage(par)



% Zero1vol = zeros(size(par.image(:,:,find(par.echo_number==1 & ...
%             par.dynamic_scan_number==1 & ...
%             par.image_type_mr == 0))));
%         
% phaseImage = zeros(size(par.image(:,:,find(par.echo_number==1 & ...
%             par.dynamic_scan_number==1 & ...
