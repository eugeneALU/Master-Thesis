...
function [data,info] = readListData(varargin)
...
% Updated by Anders Tisell 2014-02 added extr1 and extr2 

if nargin == 0

[FileName,PathName] = uigetfile('*.list','Select the List-file', '../../fMRIData/');
