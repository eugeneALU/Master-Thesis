function  varargout = imshow3D( Img, disprange, colorMapToUse )
...
SelectSlice = uicontrol('Style', 'pushbutton', 'Position', Slicetxt_Pos, 'String','Want This Slice', 'BackgroundColor', [1 1 1], 'FontSize', LVFntSz, 'Callback' ,@SetSlice);
